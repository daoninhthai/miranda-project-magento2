 ...
 **/
console.log('init Magetop/SellerTableRateShipping/view/frontend/web/js/shipping-save-processor-default-override.js')
define(
    [
        'jquery',    
        'ko',
    ...
    function ($, ko, quote, resourceUrlManager, storage, paymentService, methodConverter, errorProcessor) {
        ...
        return {
            saveShippingInformation: function() {
                ...
                console.log('data post table rate shipping : '+total_shipping_price+'split'+string_seller);                
                var payload = {
                    ...
                    addressInformation: {
                        ...
                        extension_attributes: {
                            table_rate_shipping: total_shipping_price+'split'+string_seller
                        }
                    }
                };
