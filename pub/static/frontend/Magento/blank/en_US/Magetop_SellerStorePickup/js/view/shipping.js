...
define(
    ...
    function (
        ...
        var popUp = null;
        var store_pickup_enableConfig = window.checkoutConfig.store_pickup_enable;    
        var seller_store_pickup = window.checkoutConfig.seller_store_pickup;    
        return Component.extend({
            defaults: {
                template: 'Magetop_SellerStorePickup/shipping'
            },
            ...
            canVisibleBlock: store_pickup_enableConfig,
            ...
            initialize: function () {
                ...
                this.sayHello = seller_store_pickup;	
                this.displayMessage = ko.observable(false);
                console.log(seller_store_pickup);
                return this;
            },
            ...
            validateShippingInformation: function () {
                ...
                if (!quote.shippingMethod()) {
                    ...
                    var check_radio;
                    if(($('input[id="s_method_sellerstorepickup_sellerstorepickup"]:checked').length == 1) || ($('input[id="s_method_sellerstorepickup"]:checked').length == 1)){
                        $.each(seller_store_pickup, function(index, value) {
                            if($("select[name='"+value['input_name']+"']").val() != '') {
                    ...
                    if(check_radio == 'notok'){      
                        this.errorValidationMessage('Please specify all seller shipping method in Marketplace Seller Store Pickup');
                        return false;  
                    }                    
                }
