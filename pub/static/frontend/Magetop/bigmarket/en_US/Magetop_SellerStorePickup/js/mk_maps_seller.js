    ...
    var sellerStorePickupBackendMap = function () {
        this.getSellerStorePickupPoint = function (latti,lonti,intZoom) {
			...
			google.maps.event.addListener(autocomplete, 'place_changed', function() {
                ...
                document.getElementById('sellerstorepickup_latitude').style.background = '#FAE6B4';
                document.getElementById('sellerstorepickup_longitude').style.background = '#FAE6B4';
                document.getElementById('sellerstorepickup_shop_location').style.background = '#FAE6B4';
            ...
            google.maps.event.addListener(map, 'zoom_changed', function() {            
                ...
                document.getElementById('sellerstorepickup_zoom_level').value = zoomLevel;
                document.getElementById('sellerstorepickup_zoom_level').style.background = '#FAE6B4';
            }.bind(this));            
		}
	}
