...
class View extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if($isseller){	
    		...
    		$resultPageFactory->getConfig()->getTitle()->set(__('Vacation Setting'));	
    		if($breadcrumbs = $resultPageFactory->getLayout()->getBlock('breadcrumbs')){
                ...
                $breadcrumbs->addCrumb('market_menu_seller_vacation',
                    [
                        'label' => __('Vacation Setting'),
                        'title' => __('Vacation Setting')
                    ]
                ); 
            }            
