 ...
 */
namespace Magetop\Themes\Controller\Adminhtml;
abstract class Action extends \Magento\Backend\App\Action
{
    const CMS = 'code/Magetop/Themes/etc/import/%s/';
    /**
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed("Magetop_Themes::themes_$action");
    }
}
