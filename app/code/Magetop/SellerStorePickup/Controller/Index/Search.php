...
class Search extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        $data['map_search'] = $this->_objectManager->create('\Magento\Framework\View\LayoutInterface')
            ->createBlock(
                "Magetop\SellerStorePickup\Block\Search",
                "block_name",
                ['data' => [
            ...
            ->setTemplate('Magetop_SellerStorePickup::sellerstorepickup/search.phtml')
            ->toHtml();
        $data['slidebar_left'] = $this->_objectManager->create('\Magento\Framework\View\LayoutInterface')
            ...
            ->setTemplate('Magetop_SellerStorePickup::sellerstorepickup/slidebar.phtml')
            ->toHtml();
