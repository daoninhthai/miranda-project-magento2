 ...
 * Post model
 *
 * @method \Magetop\Blog\Model\ResourceModel\Post _getResource()
 * @method \Magetop\Blog\Model\ResourceModel\Post getResource()
...
class Post extends \Magento\Framework\Model\AbstractModel
{
     ...
     */
    const BASE_MEDIA_PATH = 'magetop_blog';
     ...
     * @var string
     */
    protected $_eventPrefix = 'magetop_blog_post';
    ...
    /**
     * @var \Magetop\Blog\Model\ResourceModel\Category\CollectionFactory
     */
     ...
     * @param \Magetop\Blog\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory
    ...
    public function __construct(
        ...
        Url $url,
        \Magetop\Blog\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory,
    ...
    {
        $this->_init('Magetop\Blog\Model\ResourceModel\Post');
    }
     ...
     * @return \Magetop\Blog\Model\ResourceModel\Category\Collection
     */
    ...
    public function getRelatedPosts($storeId = null)
    {
        if (!$this->hasData('related_posts')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('magetop_blog_post_relatedpost')],
    ...
    public function getRelatedProducts($storeId = null)
    {
        if (!$this->hasData('related_products')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('magetop_blog_post_relatedproduct')],
