...
class Edit extends \Magento\Backend\Block\Widget\Form\Container 
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Magetop_SellerAttributeManagement::sellerattributemanagement')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
    ...
    protected function _prepareLayout()
    {
        $this->_formScripts[] = "
            function toggleEditor() {
                if (tinyMCE.getInstanceById('sellerattributemanagement_content') == null) {
                    tinyMCE.execCommand('mceAddControl', false, 'sellerattributemanagement_content');
                } else {
                    tinyMCE.execCommand('mceRemoveControl', false, 'sellerattributemanagement_content');
                }
            };
        ";
