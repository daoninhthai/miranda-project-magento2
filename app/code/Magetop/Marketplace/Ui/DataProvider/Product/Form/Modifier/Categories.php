                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    'formElement' => 'select',
                                    'componentType' => 'field',
                                    'component' => 'Magetop_Marketplace/js/components/new-category',
                                    'filterOptions' => true,
                                    'chipsEnabled' => true,
                                    'disableLabel' => true,
                                    'levelsVisibility' => '1',
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'actions' => [
                                        [
                                            'targetName' => 'magetopmarketproduct_form.magetopmarketproduct_form.create_category_modal',
                                            'actionName' => 'toggleModal',
                                        ],
                                        [
                                            'targetName' =>
                                                'magetopmarketproduct_form.magetopmarketproduct_form.create_category_modal.create_category',
                                            'actionName' => 'render'
                                        ],
                                        [
                                            'targetName' =>
