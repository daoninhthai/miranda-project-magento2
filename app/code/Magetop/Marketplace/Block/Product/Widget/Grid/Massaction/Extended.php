...
namespace Magetop\Marketplace\Block\Product\Widget\Grid\Massaction;

class Extended extends \Magetop\Marketplace\Block\Product\Widget
{
    /**
     * Massaction items
     *
     ...
     * @var string
     */
    protected $_template = 'Magetop_Marketplace::product/widget/grid/massaction_extended.phtml';
