...
class Container extends \Magetop\Marketplace\Block\Product\Widget\Container
{
    /**#@+
     ...
     * @var string
     */
    protected $_blockGroup = 'Magetop_Marketplace';

    /**
     * @var string
     */
    protected $_template = 'Magetop_Marketplace::product/widget/grid/container.phtml';
