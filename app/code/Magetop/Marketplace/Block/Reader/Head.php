 ...
 */
namespace Magetop\Marketplace\Block\Reader;
 ...
 */
class Head extends \Magento\Framework\View\Element\Template\Context implements Layout\ReaderInterface
{
    /**#@+
     * Supported types
     */
    const TYPE_HEAD = 'head';
	const MK_TYPE_HEAD = 'heads';
    /**#@-*/
    ...
    {
        if($this->getPageLayout()=='market-layout'){
			return [self::MK_TYPE_HEAD];
		}else{
    ...
    {	
		return $this->getLayout()->getUpdate()->getPageLayout();
    }
