<?php
namespace Magetop\SellerDHLShipping\Controller\Shipment;
...
class Printpdf extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $marketplaceOrder = $this->_objectManager->create('Magetop\Marketplace\Model\Orders')
                                    ->getCollection()
