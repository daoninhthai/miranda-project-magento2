...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_SellerMembership';

        parent::_construct();

        if ($this->_isAllowedAction('Magetop_SellerMembership::sellermembership')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
        ...
        $this->_formScripts[] = "
            function toggleEditor() {
                if (tinyMCE.getInstanceById('category_content') == null) {
                    tinyMCE.execCommand('mceAddControl', false, 'sellermembership_content');
                } else {
                    tinyMCE.execCommand('mceRemoveControl', false, 'sellermembership_content');
                }
            };
        ";
